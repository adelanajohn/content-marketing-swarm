...
# CloudFront Origin Access Control (OAC) - newer than OAI
...
resource "aws_cloudfront_distribution" "frontend" {
  ...
  # Aliases (custom domains) if provided
...
# CloudFront distribution for images (optional, for better performance)
resource "aws_cloudfront_distribution" "images" {
  count = var.create_images_cdn ? 1 : 0
